...
mydb.commit()  # Commit the transaction after closing the cursor
...
def Aggre_user_plot_2(df,quarter):
    ...
    fig_pie_1= px.pie(data_frame=auqs, names= "Brands", values="Transaction_count", 
...
def ques1():
    ...
    fig_brands= px.pie(brand2, values= "Transaction_count", names= "Brands", color_discrete_sequence=px.colors.sequential.dense_r, width=900, height=800,
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        if method_map == "Map Insurance Analysis":
            ...
            map_insure_plot_1(df_map_insur_Y_Q, state_m2)
            ...
            map_insure_plot_1(df_map_tran_Y_Q, state_m4)
